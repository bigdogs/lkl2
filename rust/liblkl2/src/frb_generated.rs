...
fn wire__crate__file__get_field_values_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::file::get_field_values(
                            api_field, api_search, api_limit, api_offset,
                        )?;
                        Ok(output_ok)
                    })(),
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__file__get_field_values_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__file__get_file_status_impl(port, ptr, rust_vec_len, data_len),
