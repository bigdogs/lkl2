...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -468227548;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateFileInit({required String logDir});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateFileInit({required String logDir}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFileInitConstMeta,
        argValues: [logDir],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFileInitConstMeta =>
      const TaskConstMeta(debugName: "init", argNames: ["logDir"]);
  ...
  RenderCell dco_decode_render_cell(dynamic raw) {
    ...
    return RenderCell(
      ...
      tooltip: dco_decode_opt_String(arr[4]),
      elements: dco_decode_list_render_element(arr[5]),
    );
  }
  ...
  RenderElement dco_decode_render_element(dynamic raw) {
    ...
    return RenderElement(
      ...
      style: dco_decode_opt_String(arr[1]),
      tooltip: dco_decode_opt_String(arr[2]),
    );
  }
  ...
  Log sse_decode_log(SseDeserializer deserializer) {
    ...
    return Log(id: var_id, fields: var_fields, snippet: var_snippet);
  }
  ...
  RenderCell sse_decode_render_cell(SseDeserializer deserializer) {
    ...
    var var_tooltip = sse_decode_opt_String(deserializer);
  ...
  void sse_encode_render_cell(RenderCell self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.tooltip, serializer);
